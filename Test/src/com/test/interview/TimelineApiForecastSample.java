...
public class TimelineApiForecastSample {
	public static void timelineRequestHttpClient() throws Exception {
		...
		String startDate="2024-12-03";
		String endDate="2024-12-25";
		
		String unitGroup="us";
		String apiKey="JRT9UGDBMR89NTNMA4Y52DATR";
		apiEndPoint = "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/London,UK/2020-10-01/2020-12-31"; 
